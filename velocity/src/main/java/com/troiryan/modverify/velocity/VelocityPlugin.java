...
public final class VelocityPlugin {
	...
	public void onServerLogin(ServerLoginPluginMessageEvent event) {
		if (event.getIdentifier().getId().equals("hacky-mod-verify:request_mods")) {
			event.getConnection().getPlayer().sendPluginMessage(event.getIdentifier(), event.getContents());
		}
	}
}